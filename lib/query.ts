...
export class Query {
  ...
  facet(options: FacetOptions): Query {
    ...
    if (
      this.solrVersion &&
      versionUtils.version(this.solrVersion) >= versionUtils.Solr4_0
    ) {
      if (options.pivot) {
  ...
  hl(options: HlOptions): Query {
    ...
    if (options.q !== undefined) {
      if (typeof options.q === 'string') {
        ...
        this.parameters.push(
          'hl.q=' + querystring.stringify(options.q, '%20AND%20', ':')
        );
      }
    }
    ...
    if (options.mergeContiguous !== undefined) {
      this.parameters.push(
        'hl.mergeContiguous=' + encodeURIComponent(options.mergeContiguous)
      );
    }
    if (options.requireFieldMatch !== undefined) {
      this.parameters.push(
        'hl.requireFieldMatch=' + encodeURIComponent(options.requireFieldMatch)
      );
    }
    if (options.maxAnalyzedChars !== undefined) {
      this.parameters.push(
        'hl.maxAnalyzedChars=' + encodeURIComponent(options.maxAnalyzedChars)
      );
    }
    ...
    if (options.alternateField) {
      this.parameters.push(
        'hl.alternateField=' + encodeURIComponent(options.alternateField)
      );
    }
    ...
    if (options.formatter) {
      this.parameters.push(
        'hl.formatter=' + encodeURIComponent(options.formatter)
      );
    }
    if (options.simplePre) {
      this.parameters.push(
        'hl.simple.pre=' + encodeURIComponent(options.simplePre)
      );
    } else {
    ...
    if (options.simplePost) {
      this.parameters.push(
        'hl.simple.post=' + encodeURIComponent(options.simplePost)
      );
    } else {
    ...
    if (options.fragmenter) {
      this.parameters.push(
        'hl.fragmenter=' + encodeURIComponent(options.fragmenter)
      );
    }
    ...
    if (options.regexSlop !== undefined) {
      this.parameters.push(
        'hl.regex.slop=' + encodeURIComponent(options.regexSlop)
      );
    }
    if (options.regexPattern) {
      this.parameters.push(
        'hl.regex.pattern=' + encodeURIComponent(options.regexPattern)
      );
    }
    ...
    if (options.preserveMulti !== undefined) {
      this.parameters.push(
        'hl.preserveMulti=' + encodeURIComponent(options.preserveMulti)
      );
    }
  ...
  terms(options: TermsOptions): Query {
    ...
    if (options.lowerIncl !== undefined) {
      this.parameters.push(
        'terms.lower.incl=' + encodeURIComponent(options.lowerIncl)
      );
    }
    if (options.mincount !== undefined) {
    ...
    if (options.regexFlag !== undefined) {
      this.parameters.push(
        'terms.regexFlag=' + encodeURIComponent(options.regexFlag)
      );
    }
    if (options.limit !== undefined) {
    ...
    if (options.upperIncl !== undefined) {
      this.parameters.push(
        'terms.upper.incl=' + encodeURIComponent(options.upperIncl)
      );
    }
